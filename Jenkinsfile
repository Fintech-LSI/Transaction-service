pipeline {
    ...
    environment {
        ...
        NAMESPACE = 'fintech'
        SONAR_PROJECT_KEY = 'transaction-service'
                    ...
                    withCredentials([[
                        ...
                        try {
                            sh """
                                ...
                                kubectl get pods -n ${NAMESPACE} -l app=transaction-service
                            """
                        } catch (Exception e) {
    ...
    post {
        success {
            echo 'Pipeline succeeded! Transaction service deployed successfully.'
        }
        failure {
